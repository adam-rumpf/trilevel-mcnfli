...
![Python 3.8](https://img.shields.io/badge/python-3%2E8-blue) ![CPLEX 22.1](https://img.shields.io/badge/cplex-22%2E1-orange) ![GitHub Tag](https://img.shields.io/github/v/tag/adam-rumpf/trilevel-mcnfli) ![GitHub License](https://img.shields.io/github/license/adam-rumpf/trilevel-mcnfli)
...
This module makes use of the [CPLEX Python API](https://www.ibm.com/docs/en/icos/22.1.2?topic=apis-cplex-python-users) for solving the various linear and mixed-integer programs involved in the trilevel game. It was written for Python 3.8.10 and [CPLEX 22.1.1](https://www.ibm.com/products/ilog-cplex-optimization-studio).
